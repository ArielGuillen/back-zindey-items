...
- template.yaml - A template that defines the application's AWS resources.
  - This template includes:
    ...
    - S3 buckets with their associated policy.
      ...
      - Abucket for load items from csv file(Restrict Access).
...
Tests are not defined already. 
to implement: In the `src/tests` folder in this project. Use NPM to install the [Mocha test framework](https://mochajs.org/) and run unit tests.
